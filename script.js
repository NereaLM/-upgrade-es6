...
let filterVideogames = videogames.filter(game => videogames.genders = "RPG")
console.log("Filtered videogames: ", filterVideogames)

let scoreVideogames = filterVideogames.reduce((total, games) => {
    return total += games.score
}, 0)

let mediaScores = scoreVideogames / filterVideogames.length
console.log("Media score videogames: ", mediaScores) 